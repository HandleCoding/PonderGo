...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            board_cmd::set_komi,
            board_cmd::set_markup,
            board_cmd::remove_markup,
            board_cmd::clear_markup,
            ...
            engine_cmd::analyze_with_constraints,
            engine_cmd::clear_analysis_constraints,
            ...
            engine_cmd::get_analysis2_overview,
            sgf_cmd::load_sgf,
            sgf_cmd::save_sgf,
